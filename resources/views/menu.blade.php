...
<head>
    ...
    <!-- ico-font -->
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/themeforest/html_n_resources/assets/css/icofont.css') }}">

    <!-- Themify icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/themeforest/html_n_resources/assets/css/themify.css') }}">

    <!-- Flag icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/themeforest/html_n_resources/assets/css/flag-icon.css') }}">

    <!-- prism css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/themeforest/html_n_resources/assets/css/prism.css') }}">

    <!-- Owl css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('themes/themeforest/html_n_resources/assets/css/owlcarousel.css') }}">
    ...
    <div class="page-main-header">
        <div class="main-header-left">
            <div class="logo-wrapper">
                <a href="index.html">
                    <img src="{{ asset('themes/themeforest/html_n_resources/assets/images/logo-light.png') }}" class="image-dark" alt=""/>
                    <img src="{{ asset('themes/themeforest/html_n_resources/assets/images/logo-light-dark-layout.png') }}" class="image-light" alt=""/>
                </a>
            </div>
        </div>
                ...
                <ul class="nav-menus">
                    ...
                    <li>
                        <a href="#!" onclick="javascript:toggleFullScreen()" class="text-dark">
                            <img class="align-self-center pull-right mr-2" src="{{ asset('themes/themeforest/html_n_resources/assets/images/dashboard/browser.png') }}" alt="header-browser">
                        </a>
                    </li>
                    <li class="onhover-dropdown">
                        <a href="#!" class="txt-dark">
                            <img class="align-self-center pull-right mr-2" src="{{ asset('themes/themeforest/html_n_resources/assets/images/dashboard/translate.png') }}" alt="header-translate">
                        </a>
                    ...
                    <li class="onhover-dropdown">
                        <a href="#!" class="txt-dark">
                            <img class="align-self-center pull-right mr-2" src="themes/themeforest/html_n_resources/assets/images/dashboard/notification.png" alt="header-notification">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media  align-items-center">
                            <img class="align-self-center pull-right mr-2" src="{{ asset('themes/themeforest/html_n_resources/assets/images/dashboard/user.png') }}" alt="header-user"/>
                            <div class="media-body">
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-sidebar custom-scrollbar">
            <div class="sidebar-user text-center">
                <div>
                    <img class="img-50 rounded-circle" src="{{ asset('themes/themeforest/html_n_resources/assets/images/user/1.jpg') }}" alt="#">
                </div>
...
<!-- Chart JS-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/chart/Chart.min.js') }}"></script>

<!-- Morris Chart JS-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/morris-chart/raphael.js') }}"></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/morris-chart/morris.js') }}"></script>

<!-- owlcarousel js-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/owlcarousel/owl.carousel.js') }}" ></script>

<!-- Sidebar jquery-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/sidebar-menu.js') }}" ></script>

<!--Sparkline  Chart JS-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/sparkline/sparkline.js') }}"></script>

<!--Height Equal Js-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/height-equal.js') }}"></script>

<!-- prism js -->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/prism/prism.min.js') }}"></script>

<!-- clipboard js -->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/clipboard/clipboard.min.js') }}" ></script>

<!-- custom card js  -->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/custom-card/custom-card.js') }}" ></script>

<!-- Theme js-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/script.js') }}" ></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/theme-customizer/customizer.js') }}"></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/chat-sidebar/chat.js') }}"></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/dashboard-default.js') }}" ></script>

<!-- Counter js-->
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/counter/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/counter/jquery.counterup.min.js') }}"></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/counter/counter-custom.js') }}"></script>

<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/notify/bootstrap-notify.min.js') }}"></script>
<script src="{{ asset('themes/themeforest/html_n_resources/assets/js/notify/index.js') }}"></script>
