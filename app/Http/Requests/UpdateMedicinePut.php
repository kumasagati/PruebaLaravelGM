...
class UpdateMedicinePut extends FormRequest
{
    /**
    ...
    {
        return [
            "med_name" => "required|max:100",
            "med_pharmaceutical_form" => "required",
            "med_image" => "image|dimensions:min_width=635,min_height=595,max_width=645,max_height=605",
